    ...
    <div className="space-y-6">
      ...
      <Card className="border-l-4 border-l-primary">
        <CardContent className="pt-6">
          <p className="text-sm text-foreground leading-relaxed mb-2">
            In this section, we are gathering information about the participant's health behaviours around smoking history, alcohol intake and recreational cannabis use. This information will allow us to explore the health behaviours of the population.
          </p>
          <p className="text-sm text-foreground leading-relaxed mb-2">
      ...
      <Card>
        ...
        <CardContent className="space-y-8">
          ...
          <div className="space-y-3 pt-4 border-t border-border">
            <Label className="text-base font-medium text-foreground">
              b. Vaping history: Has the participant ever vaped?
            </Label>
      ...
      <Card>
        ...
        <CardContent className="space-y-8">
          ...
          <div className="space-y-3">
            <Label className="text-base font-medium text-foreground">
              a. Recreational cannabis: Has the participant ever taken recreational cannabis?
            </Label>
