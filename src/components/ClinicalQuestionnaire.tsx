        ...
        <Card className="mb-6 border-l-4 border-l-primary">
          <CardContent className="pt-6">
            <p className="text-sm text-foreground leading-relaxed mb-4">
              Data is collected around a clinical encounter. An encounter is any
              interaction between a patient and a healthcare provider that
              involves delivering healthcare services/generating data. These
              encounters can vary in purpose, setting, and duration, but they
              all aim to address a patient's health need and generate data.
            </p>
            <div className="bg-accent/50 rounded-md p-3 mb-4">
              <p className="text-sm text-accent-foreground">
                ...
                important as it will alert the data collector to initiate a new
